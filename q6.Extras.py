...
17
'''
	NoBalls = int(input())	NoBalls = int(input())
	Wides = int(input())	Wides = int(input())
	Byes = int(input())	Byes = int(input())
	LedByes = int(input())	LedByes = int(input())
	Penalty = int(input())	Penalty = int(input())
